...
def compare_observed_to_predicted(observed, predicted):
    ...
    entity_F_score = printResult('Entity', correct_entity, prec, rec)
    # print()

    prec = correct_sentiment/total_predicted
    rec = correct_sentiment/total_observed
    entity_type_F_score = printResult('Entity Type',correct_sentiment, prec, rec)

    return entity_F_score, entity_type_F_score
...
def computeAcc(gold_data_path,pred_path):
    gold = open(gold_data_path, "r")
    prediction = open(pred_path, "r")
    discardInstance = []
    ...
    # Compare
    entity_F_score, entity_type_F_score = compare_observed_to_predicted(observed, predicted)
